...
public class RefBookAdapter extends FirebaseRecyclerAdapter<RefBook, RefBookAdapter.RefBookViewHolder> {


    private Context context;

    public RefBookAdapter(@NonNull FirebaseRecyclerOptions<RefBook> options, Context context) {
        super(options);
        this.context=context;
    }

    @Override
    protected void onBindViewHolder(@NonNull final RefBookViewHolder holder, final int i, @NonNull final RefBook refbook) {
    ...
    @NonNull
    @Override
    public RefBookViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.refbook , parent, false);

        return new RefBookViewHolder(view);
    }
